...
\section{Background and Research Objectives}
    ...
    Historical wildfire data will be obtained from:
    \begin{itemize}
        \item \textbf{Monitoring Trends in Burn Severity (MTBS)} for perimeters, burn severity indices, and postfire vegetation conditions across the PNW.
        \item \textbf{National Interagency Fire Center (NIFC)} and Incident Command System (ICS-209) records for resource mobilization, fire duration, personnel deployment, and suppression costs.
    \end{itemize}
    
    \subsubsection{Environmental and Climatic Variables}
    Environmental conditions influencing and influenced by wildfires will be captured from:
    \begin{itemize}
        \item \textbf{PRISM Climate Group} datasets for temperature and precipitation.
        \item \textbf{TerraClimate} reanalysis datasets for wind speed.
        \item \textbf{Stanford EchoLab} wildfire smoke PM2.5 data.
    \end{itemize}
    
    \subsubsection{Infrastructure and Energy Systems}
    Wildfire impacts on energy infrastructure will be modeled using:
    \begin{itemize}
        \item \textbf{U.S. Energy Information Administration (EIA)} data on electricity generation and total energy output.
    \end{itemize}
    
    \subsubsection{Socioeconomic and Community Vulnerability}
    Societal exposure and displacement potential will be analyzed through:
    \begin{itemize}
        \item \textbf{U.S. Census Bureau and FEMA} datasets for population density and social vulnerability index.
    \end{itemize}
    
    Together, these datasets provide a comprehensive foundation for examining the intersection of wildfire occurrence, firefighting resource demand, and multi-sectoral impacts across the Pacific Northwest.
...
\section{Results}
    ...
    \subsection{Temporal Results}
        ...
        \begin{center}
            \includegraphics[width=\linewidth]{1Figure_2.png}
            Figure 2: fire size as a function of mean annual temperature. Data source: MTBS, PRISM.
        \end{center}

        \begin{center}
            \includegraphics[width=\linewidth]{1Figure_3.png}
            Figure 3: fire size as a function of mean annual precipitation. Data source: MTBS, PRISM.
        \end{center}

        \begin{center}
            \includegraphics[width=\linewidth]{1Figure_4.png}
            Figure 4: random Forest Regressor to estimate importance of different climate variables on fire size. Data source: PRISM, U.S. Drought Monitor via UNL. 
        \end{center}

        \begin{center}
            \includegraphics[width=\linewidth]{1Figure_5.png}
            Figure 5: various drought-related analyses. Data source: U.S. Drought Monitor via UNL. 
            \begin{verbatim}
            Temperature difference p-value: 0.437
            \end{verbatim}
        \end{center}
        ...
        \begin{center}
            \includegraphics[width=\linewidth]{2Figure_5.png}
        ...
        \begin{center}
            \includegraphics[width=\linewidth]{3Figure_3.png}
            Figure 14: fire size versus climate risk index. Data source: MTBS, PRISM, U.S. Drought Monitor via UNL, TerraClimate.
        \end{center}

        \begin{center}
            \includegraphics[width=\linewidth]{4Figure_1.png}
            Figure 15: lectricity generation versus fire activity. Data source: MTBS, EIA.
        \end{center}
        ...
        \begin{center}
            \includegraphics[width=\linewidth]{4Figure_3.png}
            Figure 17: electricity generation in major or minor fire years. Data source: MTBS, EIA.
            \begin{verbatim}
                Major Fire Years: [2012, 2007, 2015, 2020, 2000]
            \end{verbatim}
        \end{center}
...
\subsubsection{Wildfire Data}
\begin{itemize}
    \item \textbf{Monitoring Trends in Burn Severity (MTBS)} \\
    Fire perimeters and burn severity indices \\
    \texttt{https://www.mtbs.gov/direct-download}
    
    \item \textbf{ICS-209 Incident Reports} \\
    Firefighting resource deployment and suppression costs \\
    U.S. Forest Service Fire Modeling Institute \\
    \texttt{https://research.fs.usda.gov/firelab/products/dataandtools/ics-209-plus}
\end{itemize}

\subsubsection{Climate and Environmental Data}
\begin{itemize}
    \item \textbf{U.S. Drought Monitor - Drought Severity and Coverage Index (DSCI)} \\
    Weekly drought severity classifications \\
    University of Nebraska-Lincoln \\
    \texttt{https://droughtmonitor.unl.edu/DmData/DataDownload/DSCI.aspx}
    
    \item \textbf{PRISM Climate Group} \\
    Temperature and precipitation \\
    Oregon State University \\
    \texttt{https://prism.oregonstate.edu/data/}
    
    \item \textbf{TerraClimate} \\
    Wind speed \\
    Climatology Lab \\
    \texttt{https://www.climatologylab.org/terraclimate.html}
    
    \item \textbf{Stanford EchoLab Wildfire Smoke Dataset} \\
    Daily PM2.5 concentrations from wildfire smoke \\
    Stanford University \\
    \texttt{https://www.stanfordecholab.com/wildfire\_smoke}
\end{itemize}

\subsubsection{Infrastructure and Energy}
\begin{itemize}
    \item \textbf{U.S. Energy Information Administration (EIA)} \\
    Electricity generation and power plant locations \\
    \texttt{https://www.eia.gov/opendata/browser/}
\end{itemize}

\subsubsection{Socioeconomic and Vulnerability}
\begin{itemize}
    \item \textbf{CDC/ATSDR Social Vulnerability Index (SVI)} \\
    County-level social vulnerability indicators \\
    Centers for Disease Control and Prevention \\
    Agency for Toxic Substances and Disease Registry \\
    \texttt{https://www.atsdr.cdc.gov/place-health/php/svi/svi-data-documentation-download.html}
\end{itemize}
